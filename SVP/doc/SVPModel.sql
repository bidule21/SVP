...
-- Table `svp`.`member`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`member` ;
...
-- Table `svp`.`profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`profile` ;
...
-- Table `svp`.`sequence`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`sequence` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`competition` ;
...
-- Table `svp`.`price`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`price` ;
...
-- Table `svp`.`award`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`award` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`participant` ;
...
-- Table `svp`.`group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`group` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`group_has_member` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`participant_has_member` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`price_has_winner` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`evaluation` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`participant_has_sequence` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`sequence_has_newSequence` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`disagProfile` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`manualProfile` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`award_has_winner` ;
...
-- -----------------------------------------------------
-- Table `svp`.`price_has_evaluation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`price_has_evaluation` ;

CREATE TABLE IF NOT EXISTS `svp`.`price_has_evaluation` (
  `price_id` INT NOT NULL,
  `evaluation_id` INT NOT NULL,
  PRIMARY KEY (`price_id`, `evaluation_id`),
  INDEX `fk_price_has_evaluation_evaluation1_idx` (`evaluation_id` ASC),
  INDEX `fk_price_has_evaluation_price1_idx` (`price_id` ASC),
  CONSTRAINT `fk_price_has_evaluation_price1`
    FOREIGN KEY (`price_id`)
    REFERENCES `svp`.`price` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_price_has_evaluation_evaluation1`
...
-- -----------------------------------------------------
-- Table `svp`.`price_has_sequence`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `svp`.`price_has_sequence` ;

CREATE TABLE IF NOT EXISTS `svp`.`price_has_sequence` (
  `price_id` INT NOT NULL,
  `sequence_id` INT NOT NULL,
  PRIMARY KEY (`price_id`, `sequence_id`),
  INDEX `fk_price_has_sequence_sequence1_idx` (`sequence_id` ASC),
  INDEX `fk_price_has_sequence_price1_idx` (`price_id` ASC),
  CONSTRAINT `fk_price_has_sequence_price1`
    FOREIGN KEY (`price_id`)
    REFERENCES `svp`.`price` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_price_has_sequence_sequence1`
    FOREIGN KEY (`sequence_id`)
    REFERENCES `svp`.`sequence` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
