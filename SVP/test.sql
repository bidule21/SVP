...
-- -----------------------------------------------------------
-- Date Created: 03/22/2018 15:41:39
...
--    ALTER TABLE `Sequences` DROP CONSTRAINT `FK_SequenceSequence`;
...
--    ALTER TABLE `Profiles_DisagProfile` DROP CONSTRAINT `FK_DisagProfile_inherits_Profile`;

--    ALTER TABLE `Profiles_ManualProfile` DROP CONSTRAINT `FK_ManualProfile_inherits_Profile`;
...
SET foreign_key_checks = 0;
    ...
    DROP TABLE IF EXISTS `Profiles_DisagProfile`;

    DROP TABLE IF EXISTS `Profiles_ManualProfile`;
